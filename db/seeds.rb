...
GroupExercise.create!(weekday: 'Tuesday', time: '17:00', name: 'Zumba', place: 'Thangs Gym Oslo', intructor: 'Thang Phan', available_slots: 40 )
GroupExercise.create!(weekday: 'Wednesday', time: '17:00', name: 'Zumba', place: 'Thangs Gym Oslo', intructor: 'Thang Phan', available_slots: 40 )
GroupExercise.create!(weekday: 'Tuesday', time: '17:00', name: 'Zumba', place: 'Thangs Gym Oslo', intructor: 'Thang Phan', available_slots: 40 )
GroupExercise.create!(weekday: 'Friday', time: '17:00', name: 'Zumba', place: 'Thangs Gym Oslo', intructor: 'Thang Phan', available_slots: 40 )